...
export default function DisplayLayout() {
  ...
  return (
    ...
    >
      ...
      <Box className="rounded-lg bg-background-50 mb-6">
        <Table className="w-full">
          <TableHeader>
            <TableRow>
              <TableHead>Producto Destacado</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            <TableRow>
              <TableData>
                <Card className="p-5 rounded-lg max-w-[360px] mx-auto">
                  <Image
                    source={{
                  ...
                  <HStack className="items-center justify-between mb-4">
                    <VStack>
                      <Text
                        size="xs"
                        className="text-typography-500 line-through"
                      >
                        $999
                      </Text>
